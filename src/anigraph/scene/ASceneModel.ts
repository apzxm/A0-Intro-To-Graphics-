...
import {BezierTween, NodeTransform3D, V3} from "../math";
...
export abstract class ASceneModel extends AModel implements HasModelMap, HasInteractions, ConfirmInitialized{
