...
export class AxesView extends ANodeView {
    ...
    _arrowheadSize:number=AppConfig.ArrowheadSize;
    ...
    _update!: (view: AxesView, ...args: any[]) => void;
    ...
    static Create(model: AxesModel, update: (view: AxesView, ...args: any[]) => void) {
        let view = new this();
        view._update = update;
        view.setModel(model);
        view.update();
    ...
    _initArrowGraphics(){
        ...
        this.unitXGraphic.setLineWidth(AppConfig.VectorWeight);
        this.unitYGraphic.setLineWidth(AppConfig.VectorWeight);
        this.targetVectorGraphic.setLineWidth(AppConfig.VectorWeight);
